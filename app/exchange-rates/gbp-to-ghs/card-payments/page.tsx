...
const title = "Pound to Cedis Card Payment Rates Today";
const content =
  "Compare Card Payment Pound to Cedi rate for today. Latest exchange rates for Pounds to Cedis using debit or credit cards issued in Ghana, updated on CediRates.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://cedirates.com/exchange-rates/gbp-to-ghs/card-payments/",
  },
};

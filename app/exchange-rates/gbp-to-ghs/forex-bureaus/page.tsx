...
const title = "Pound to Cedis Forex Bureau Today";
const content =
  "Compare Forex Bureau Pound to Cedi rate for today. Latest exchange rates for Pounds to Cedis for the forex bureau in Ghana near you, updated on CediRates.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://cedirates.com/exchange-rates/gbp-to-ghs/forex-bureaus/",
  },
};

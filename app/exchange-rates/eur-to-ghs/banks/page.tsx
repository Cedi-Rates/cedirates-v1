...
const title = "Euro to Cedis Bank Rates Today";
const content =
  "Compare bank Euro to Cedi rate for today. Latest exchange rates for Euros to Cedis for the bank in Ghana near you, updated on CediRates.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://cedirates.com/exchange-rates/eur-to-ghs/banks/",
  },
};

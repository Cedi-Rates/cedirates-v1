...
const title = "Euro to Cedis Fintech Rates Today";
const content =
  "Compare fintech Euro to Cedi rate for today. Latest exchange rates for Euros to Cedis for fintechs that support Ghana, updated on CediRates.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://cedirates.com/exchange-rates/eur-to-ghs/fintech/",
  },
};

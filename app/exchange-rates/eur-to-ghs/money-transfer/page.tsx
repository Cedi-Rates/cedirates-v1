...
const title = "Euro to Cedis Money Transfer Rates Today";
const content =
  "Compare Money Transfer Euro to Cedi rate for today. Latest exchange rates for Dollars to Cedis when sending money to Ghana, updated on CediRates.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://cedirates.com/exchange-rates/eur-to-ghs/money-transfer/",
  },
};

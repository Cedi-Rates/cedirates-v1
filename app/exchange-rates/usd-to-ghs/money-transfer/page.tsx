...
const title = "Dollar to Cedis Money Transfer Rates Today";
const content =
  "Compare Money Transfer Dollar to Cedi rate for today. Latest exchange rates for Dollars to Cedis when sending money to Ghana, updated on CediRates.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://cedirates.com/exchange-rates/usd-to-ghs/money-transfer/",
  },
};

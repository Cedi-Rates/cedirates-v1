...
const title = "Dollar to Cedis Crypto Exchange Rates Today";
const content =
  "Compare Crypto Exchanges Dollar to Cedi rate for today. Latest P2P exchange rates for crypto exchanges that support Ghana, updated on CediRates.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://cedirates.com/exchange-rates/usd-to-ghs/crypto/",
  },
};
  ...
  return (
    <>
      ...
      <main className="max-w-[1450px] mx-auto">
        <ExchangeTable rates={rates} categoryHeading="Crypto" user={user} />
      </main>
      <Footer />
      <script

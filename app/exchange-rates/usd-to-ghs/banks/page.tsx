...
const title = "Dollar to Cedis Bank Rates Today";
const content =
  "Compare Bank Dollar to Cedi rate for today. Latest exchange rates for Dollars to Cedis for the bank in Ghana near you, updated on CediRates.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://cedirates.com/exchange-rates/usd-to-ghs/banks/",
  },
};

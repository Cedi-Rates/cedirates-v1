...
import {
    ...
    TelegramIcon, TelegramShareButton, TwitterShareButton, XIcon,
    WhatsappIcon, WhatsappShareButton, LinkedinIcon, LinkedinShareButton,
    EmailIcon, EmailShareButton, RedditShareButton, RedditIcon
} from 'react-share'
            ...
            axios
                ...
                .then((response) => {
                    ...
                    if (data) {
                        ...
                        // ]);
                        resolve([
                            { currency: 'USD', value: data.averageDollar.sellingRate.toFixed(2) },
                            { currency: 'GBP', value: data.averagePound.sellingRate.toFixed(2) },
                            { currency: 'EUR', value: data.averageEuro.sellingRate.toFixed(2) }
                        ]);
                    } else {
                        // resolve("-");
                        resolve([
                        ...
                        <Button className="bg-white border border-blue-500 hover:bg-blue-500 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center focus:outline-none">
                            ...
                            <div>
                                <p className="mb-4 font-normal">
                                    In today&apos;s globalised economy, navigating currency exchange rates is essential for various financial activities, including travel, commerce, and investment. CediRates, a versatile web application, serves as a comprehensive currency converter tailored to users dealing with Ghanaian Cedi (GHS) and major international currencies such as the US Dollar (USD), Euro (EUR), and British Pound (GBP). This guide will walk you through the steps of using CediRates for seamless currency conversions and highlight its utility in facilitating GHS to USD/EUR/GBP or vice versa transactions.
                                </p>
                                <div className="my-5 flex items-center gap-2">
                                    {rates.map((rate, index) => (
                                        <div key={index} className="flex items-center box-border bg-zinc-50 border border-gray-300 rounded-full px-2 cursor-pointer">
                                            ...
                                            {sorting
                                                ...
                                                :
                                                <FaSortDown color="red" className="relative bottom-0.5" />
                                            }
                                ...
                                <h3 className="text-2xl font-semibold mb-2">Getting Started with CediRates: </h3>
                                <ol>
                                    <li><p className="mb-4 font-normal"><strong>Accessing the Platform:</strong> Begin by visiting the CediRates website on your preferred web browser. As a web application, CediRates offers the convenience of instant access without requiring any downloads or installations. </p></li>
                                    <li><p className="mb-4 font-normal"><strong>Selecting Currency Pair:</strong> Upon accessing the platform, you&apos;ll be prompted to select the currency pair for conversion. Choose GHS as the base currency and select USD, EUR, or GBP as the target currency, depending on your transaction requirements. </p></li>
                                    <li><p className="mb-4 font-normal"><strong>Entering Amount:</strong> Input the amount of GHS you intend to convert into the designated field. CediRates utilises real-time exchange rates to compute the equivalent amount in the selected target currency, ensuring accuracy and transparency in your conversions.  </p></li>
                                    <li><p className="mb-10 font-normal"><strong>Viewing Conversion Results:</strong> Instantly observe the converted amount in the target currency displayed on the screen. CediRates provides precise and up-to-date exchange rate information, enabling users to make informed decisions regarding their financial transactions. </p></li>
                                </ol>
                                <h3 className="text-2xl font-semibold mb-2">Benefits of CediRates:</h3>
                                <ol>
                                    <li>
                                        <p className="mb-4 font-normal"><strong>User-Friendly Interface:</strong> CediRates boasts an intuitive interface designed for ease of use and accessibility. Whether you&apos;re a seasoned investor or a casual user, navigating the platform is straightforward and hassle-free. </p>
                                    </li>
                                    <li>
                                        <p className="mb-4 font-normal"><strong>Real-Time Exchange Rates:</strong> Access reliable exchange rate data sourced from reputable financial institutions and market sources. CediRates ensures that users have access to the latest currency values, empowering them to execute transactions with confidence. </p>
                                    </li>
                                    <li>
                                        <p className="mb-4 font-normal"><strong>Multi-Currency Support:</strong> Enjoy the flexibility of converting between a wide range of currencies beyond GHS, USD, EUR, and GBP. CediRates accommodates diverse currency pairs, catering to the needs of users engaged in international trade, travel, or investment.</p>
                                    </li>
                                    <li>
                                        <p className="mb-4 font-normal"><strong>Efficient Currency Conversion:</strong> Streamline your currency conversion process with CediRates&apos; efficient algorithm, which delivers instant results without delays or complications. Whether you&apos;re converting small amounts or large sums, CediRates simplifies the task at hand.</p>
                                    </li>
                                    <li>
                                        <p className="mb-8 font-normal"><strong>Enhanced Financial Planning:</strong> Utilize CediRates as a valuable tool for financial planning and decision-making. Monitor currency trends, analyse historical exchange rate data, and gain insights into market fluctuations to optimise your financial strategies. </p>
                                    </li>
                                </ol>
                                <p className="bn-inline-content font-normal">
                                    In conclusion, CediRates emerges as an indispensable resource for individuals and businesses seeking reliable currency conversion solutions. With its user-friendly interface, real-time exchange rates, and multi-currency support, CediRates empowers users to navigate the complexities of international finance with confidence and ease. Experience the convenience and efficiency of CediRates today, and elevate your currency conversion experience to new heights.
                                </p>
                            </div>
                        </div>

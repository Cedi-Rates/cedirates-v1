...
const DriverDialog = ({
  ...
  const watchDriverType = watch("typeOfDriver");
  ...
  return (
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      ...
      >
        ...
        <DialogDescription>
          <div className="flex justify-center items-center max-w-lg gap-10 select-none">
            <label className="ml-0 w-1/2">
              <input
                ...
                id="privateRadio"
                value="private"
                {...register("typeOfDriver")}
              />
              <span className={style.radioTile}>
                <span className={style.radioIcon}>🚗</span>
                <span className={style.radioLabel}>Private</span>
              </span>
            </label>
            <label className="mr-0 w-1/2">
              ...
              <span className={style.radioTile}>
                <span className={style.radioIcon}>🚕</span>
                <span className={style.radioLabel}>Commercial</span>
              </span>
            </label>
          </div>
        </DialogDescription>
        <Button
          ...
          type="submit"
          disabled={isSubmitting || !formData.typeOfDriver}
        >
          <DialogClose>
            {isSubmitting ? (

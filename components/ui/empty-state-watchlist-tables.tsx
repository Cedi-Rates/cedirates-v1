...
export const EmptyState: (props: any) => React.ReactNode = () => (
  <div className="w-full sm:max-w-md mx-auto flex flex-col space-y-2 px-2 my-16 ">
    ...
    <h3 className="font-semibold text-xl mb-2 text-center">No rates found</h3>
    {/* <p className="text-center text-black/60">
      When we have data for your selection it will appear here. You can adjust
      the filters to explore other rates.
    </p> */}
  </div>
);

  ...
  return (
    <div className="uppercase text-[.9rem] inline-flex p-[4px] bg-background-bg-secondary rounded-radius-md">
      <div
        ...
        className={`cursor-pointer px-2 py-1 relative z-20 hover:text-black ${
          currencyType === "dollarRates" ? "text-black" : "text-black/40"
        }`}
      >
      ...
      <div
        ...
        className={`cursor-pointer px-2 py-1 relative z-20 hover:text-black ${
          currencyType === "poundRates" ? "text-black" : "text-black/40"
        }`}
      >
      ...
      <div
        ...
        className={`cursor-pointer px-2 py-1 relative z-20 hover:text-black ${
          currencyType === "euroRates" ? "text-black" : "text-black/40"
        }`}
      >
